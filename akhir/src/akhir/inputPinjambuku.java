...
public class inputPinjambuku extends javax.swing.JFrame {
    ...
    public inputPinjambuku(PinjamBuku pb, JTable jTable1) {
        ...
        jTextField2.setText(pb.getIdMahasiswa().getIdMahasiswa());
        jTextField3.setText(pb.getIdBuku().getIdBuku());
        jTextField4.setText(pb.getTanggal());
...
//        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(tambah){
            ...
            Buku b = entityManager.find(Buku.class, idBuku);
...
// Set format tanggal yang diinginkan pada JDateChooser
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        try {
            ...
            Buku b = entityManager.find(Buku.class, tabel_klik);
            if (b != null) {
                String idBuku = b.getIdBuku();
...
//        
        ...
        tbl.setRowCount(0);
        for(PinjamBuku ps : results){
            Object[] ob = new Object[5];
            ob[0] = ps.getIdPeminjaman();
            ob[1] = ps.getIdMahasiswa().getIdMahasiswa();
            ob[2] = ps.getIdBuku().getIdBuku();
            ob[3] = ps.getTanggal();
            ob[4] = ps.getStatus();
            tbl.addRow(ob);
        }
